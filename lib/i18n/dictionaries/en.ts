const en = {
  ...
  footer: {
    ...
    legalHeading: "Legal",
    legalLinks: ["Privacy Policy", "Terms & Conditions", "ISO Certifications"],
    socialHeading: "Social Media",
    socials: ["LinkedIn", "Instagram", "YouTube"],
    copyright: "© 2024 PT. Regar Karya Utama. All Rights Reserved.",
    tagline: "Precision Enterprise",
    location: "Bekasi, Indonesia",
  },
  home: {
    hero: {
      titleLine1: "Turning E-Waste Into",
      titleLine2: "A Cleaner, Safer Future",
      description:
    ...
    products: {
      ...
      downloadCta: "Download Full Catalog",
      cat1: {
        title: "Scrap PCB",
        desc: "Printed circuit boards from various electronic devices with precious metal content optimized for the refining process.",
        items: ["Motherboards", "Server Boards", "Laptop PCB", "Desktop PCB"],
      },
      cat2: {
        title: "IC & Chip Scrap",
        desc: "Semiconductor components with high gold and silver concentrations.",
        tag: "BGA • RAM • CPU • GPU",
      },
      cat3: {
        title: "PM Connectors",
        desc: "Gold-plated connectors and high-precision sockets.",
        tag: "Gold-Plated • CPU Sockets",
      },
      cat4: {
        title: "Capacitors & Resistors",
        desc: "Passive components containing palladium and silver, processed through precision mechanical separation.",
  ...
  about: {
    hero: {
      title: "Pioneering Circularity in Indonesian Industry",
      description:
  ...
  catalog: {
    ...
    grid: {
      ...
      heading: "Find Your E-Waste Material",
    },
    ui: {
      searchLabel: "Search catalog",
      searchPlaceholder: "Search by material name, code, or category…",
      searchButton: "Search",
      sortLabel: "Sort",
      sortCode: "Item code",
      sortName: "Item name",
      ...
      allCategories: "All",
      itemsFound: "materials found",
      showing: "Showing",
      of: "of",
      materialCode: "Item code",
      emptyTitle: "No materials found",
      emptyDescription:
        "Try another keyword or clear the active category filter.",
    ...
    items: [
      {
        title: "Scrap PCB & Boards",
        desc: "Printed circuit boards from computers, servers, telecommunications equipment, and other electronic devices.",
        tag: "Motherboards • Server Boards • Control Boards",
      },
      {
        title: "IC & Chip Scrap",
        desc: "Integrated circuits and semiconductor components recovered from end-of-life electronic equipment.",
        tag: "CPU • GPU • RAM • BGA",
      },
      {
        title: "Gold-Plated Connectors",
        desc: "Connectors, pins, sockets, and contact components with recoverable precious-metal coatings.",
        tag: "Pins • Sockets • Edge Connectors",
      },
      {
        title: "Capacitors & Resistors Scrap",
        desc: "Passive electronic components sorted for responsible handling and targeted material recovery.",
        tag: "Industrial • Telecommunications • Consumer",
      },
      {
        title: "Mixed Electronic Scrap",
        desc: "Mixed components and assemblies that require careful identification, sorting, and separation.",
        tag: "Components • Assemblies • Production Scrap",
      },
    ],
  },
  contact: {
